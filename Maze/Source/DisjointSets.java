 ...
 * EDIT  - Modified by Ben Boyter to add some more functionality
...
public class DisjointSets
{
	...
	/**
	 *Preform a check to see if 2 elements are in the same set. Added by
	 *Ben Boyter.
	 *@param x The first element
	 *@param y The second element
	 *@return true if they are in the same set, otherwise false
	 */
	...
	/**
	 *Preforms a check to see if all elements are in the same set. Added by
	 *Ben Boyter.
	 *@return true if al in the same set, otherwise false.
	 */
	public boolean allSameSet()
	{
		for(int i = 0;i<s.length;i++)
